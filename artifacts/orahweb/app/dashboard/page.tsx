      ...
      <div className="bg-gradient-to-br from-blue-950 via-blue-900 to-violet-900 text-white px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-7xl mx-auto flex items-start justify-between gap-4 flex-wrap">
          ...
          {isAdmin && (
            <Link
              href="/admin"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/10 border border-white/20 text-white text-sm font-medium hover:bg-white/20 transition-colors mt-1"
            >
